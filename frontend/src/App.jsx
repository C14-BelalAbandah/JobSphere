...
const App = () => {
  ...
  <path fillRule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
            ...
            Login</button>}
          {!registerToggle && <button onClick={()=>{
navigate("register")
          }} className="registerIcon"> <svg className="iconOfRegister" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
